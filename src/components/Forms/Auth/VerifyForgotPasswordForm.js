...
function VerifyForgotPasswordCodeForm({ push }) {
  ...
  const {
    ...
    async onSubmit(values) {
      try {
        const customerForgotPasswordCredentials = getItemFromLocalStorage(
        ...
        const res = await verifyForgotPassword({
          params,
          token: customerForgotPasswordCredentials.token,
        });
        ...
        if (res) {
          ...
          localStorage.setItem(
            "customerForgotPasswordCredentials",
            JSON.stringify(customerForgotPasswordCredentials)
          );
          push("/reset-password");
        }
      } catch ({ response }) {
              ...
              <div className="fields">
                <div className="email formFieldBlock">
                  ...
                  <div
                    ...
                    data-isinvalid={touched["code"] && errors["code"]}
                  >
                    <input
